...
class Site:
    ...
    def _exploit(self, agent, agent_skill): # adicionei o "agent" aqui na funcao(). Precisa ter esse "agent_skill" aqui?
        """
	...
	if numpy.random.rand() < self.predictability:
	    exploited_resource = min(self.resource, self.resource * agent.agent_skill) # adicionei o "agent." no agent_skill).
